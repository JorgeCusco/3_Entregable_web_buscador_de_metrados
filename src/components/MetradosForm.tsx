        ...
        <div className="glass-panel rounded-2xl p-6 h-full flex flex-col">
            ...
            <div className="space-y-4 flex-grow">
                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-600 block">Elemento / Agrupador (Opcional)</label>
                        <input
                            type="text"
                            value={state.elemento}
                            onChange={e => actions.setElemento(e.target.value)}
                            className="w-full px-3 py-2 border border-gray-200 rounded-md text-sm font-medium text-slate-700 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
                            placeholder="Ej. Viga BV-206 Eje A..."
                        />
                    </div>
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-blue-600 block flex items-center gap-1">
                            <span className="text-blue-400">↳</span> Detalle (Material, Actividad, etc.)
                        </label>
                        <input
                            type="text"
                            value={state.detalle}
                            onChange={e => actions.setDetalle(e.target.value)}
                            className="w-full px-3 py-2 border border-blue-200 rounded-md text-sm border-l-4 border-l-blue-500 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
